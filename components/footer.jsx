export default function Footer() {
    return (
        <div className="bg-[#1e1a30] bg-noise w-full rounded-tl-4xl rounded-tr-4xl flex flex-col p-8 sm:p-t-16 sm:pb-8 sm:px-24">
            <h1 className="font-heading sm:text-8xl text-4xl">Aurora <span className="italic text-[#e6e6e670]">Shi</span></h1>
            <div className="flex flex-row sm:gap-24 md:gap-32 gap-6 my-8">
