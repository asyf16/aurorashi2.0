            ...
            <div className="flex flex-row gap-4 sm:right-18 right-8 absolute">
                ...
                {openMenu && (
                    <div className="flex flex-col border border-[#292442] sm:hidden fixed top-[70px] right-[10px] rounded-lg backdrop-blur-md text-[#e6e6e6] bg-[#1a1536cc] shadow-lg px-6 py-2 gap-2 text-lg">
                        <a href="#about">
                            <div className=" hover:text-[#d1c8ffff] hover:italic cursor-pointer"><span className="font-serif italic font-bold">1.</span> About</div>
                        </a>
                        <a href="#experience">
                            <div className="hover:text-[#d1c8ffff] hover:italic cursor-pointer"><span className="font-serif italic font-bold">2.</span> Experience</div>
                        </a>
                        <a href="#projects">
                            <div className="hover:text-[#d1c8ffff] hover:italic cursor-pointer"><span className="font-serif italic font-bold">3.</span> Projects</div>
                        </a>

                        <a href="#portfolio">
                            <div className="hover:text-[#d1c8ffff] hover:italic cursor-pointer"><span className="font-serif italic font-bold">4.</span> Portfolio</div>
                        </a>

                        <a href="#about">
                            <div className="hover:text-[#d1c8ffff] hover:italic cursor-pointer"><span className="font-serif italic font-bold">5.</span> Click</div>
                        </a>
                    </div>
                )}
        </div>
